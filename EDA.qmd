...
*Creating a one-way, two-way, and three-way contigency table for the factor variables created above*
...
*Creating a conditional two-way contingency (2 separate methods)*
```{r}
