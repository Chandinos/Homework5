...
```
*These three plots show how math class absences are distributed across the different family sizes. The histogram and kernel plot show how often most students miss class which is heavily right skewed. The boxplot shows a comparison of the of center and spread of math absences grouped by family size. The histogram and box plot show similarity in their distributions whereas the boxplot shows similar centers but different spreads. Students in a family of more than three members have more variation in their attendance than students from families with three or less members.*
...
```
*These three plots show how final math grades are distributed across the different family sizes.The histogram and kernel plot show similar, unimodal, distributions with most students clustered in the middle. The average final math grade is slightly better among students in a family of three or less than among students in a family of more than 3.
